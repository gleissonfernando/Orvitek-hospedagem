...
HOSTING_BOT_API_URL=http://localhost:3000
MONGODB_URI=
...
ORVITEK_HOSTING_BOT_URL=http://localhost:3000/api/orvitek/desligar
...
```env
ORVITEK_MAIN_BOT_NOTIFY_URL=https://url-do-bot-principal/hosting/bot-registered
...
```env
API_PUBLIC_URL=https://painel.seudominio.com
```
